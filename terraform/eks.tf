...
module "eks" {
  ...
  cluster_endpoint_public_access  = true  # nodes بعيد عن public internet
  ...
  subnet_ids = module.vpc.private_subnets  # كل النودز في private subnets

  # Cluster SG rules remain for private communication
...
data "aws_iam_policy_document" "cluster_autoscaler" {
  ...
  statement {
   ...
   # "rbac.serviceAccount.annotations.eks.amazonaws.com/role-arn" = module.iam_assumable_role_admin.iam_role_arn
