...
OWNER="ahmdnabil74"
REPO="end-to-end-devops-project-mongo-db"

# Set AWS credentials - ideally, these would be read from a secure source or environment variables
AWS_ACCESS_KEY_ID=$(awk -F "=" '/aws_access_key_id/ {print $2}' /c/Users/ahmed/.aws/credentials | xargs)
AWS_SECRET_ACCESS_KEY=$(awk -F "=" '/aws_secret_access_key/ {print $2}' /c/Users/ahmed/.aws/credentials | xargs)
